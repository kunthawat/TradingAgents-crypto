#!/usr/bin/env python3
"""
Direct test of memory module bypassing package imports
"""
...
def test_memory_direct():
    ...
    try:
        ...
        memory_instance = memory.FinancialSituationMemory("test_memory", config)
        print("✅ Memory system initialized with API key")
        
        # Test embedding generation
        test_text = "This is a test for embeddings API"
        try:
            embedding = memory_instance.get_embedding(test_text)
...
if __name__ == "__main__":
    memory_works = test_memory_direct()
